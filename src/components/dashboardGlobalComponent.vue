<template>
  <div class="middlecontainer">
    <div class="middlecontainer" v-if="WorldTotal">
      <div class="middlecontainer">
        <div class="desnumber">
          <div class="descomfirmedcase">
            <div :class="darkmode? 'numbercontainer1Dark' : 'numbercontainer1'">
              ...
              <div
                style="font-size:36px; color:#757575; font-weight:bold; padding-top:20px"
          ...
          <div class="desrecover">
            <div :class="darkmode? 'numbercontainer2Dark' : 'numbercontainer2'">
              ...
              >{{WorldTotal.total_recovered}}</div>
            </div>
          </div>
          <div class="desdeath">
        ...
        <div class="desmap">
          ...
          <div :class="darkmode? 'mapnameDark' : 'mapname'" >World</div>
        </div>
        <div class="desfooter">Last Updated : {{addHour(WorldTotal.statistic_taken_at)}}</div>
      </div>
    </div>

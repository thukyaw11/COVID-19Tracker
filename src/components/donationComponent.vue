<template>
  <div class="classdesbody">
      ...
      <div class="flexbody">
        <div class="flexbodycontainer">
          ...
          <div class="flexbodycontent">
            ...
            />
            <br />
            <div style="width:90%; color:#757575;">{{$t('donationPage.donationContent')}}</div>
    ...
    <transition-group :class="darkmode? 'contactsflexDark' : 'contactsflex'" class="carousel">
      <div class="backward">
        <div class="backwardbutton" @click="previous">
          <i class="material-icons" style="font-size:50px; color:#212121;">keyboard_arrow_left</i>
        </div>
      </div>
      <div class="middle slide" v-for="slide in slides" :key="slide.id">
        <div :class="darkmode? 'donationcardDark' : 'donationcard'">
          <div class="dcardheader">{{slide.title}}</div>
          <div class="dcardbody">
      ...
      <div class="forward">
        <div class="backwardbutton" @click="next">

    ...
    <div class="container" v-if="WorldTotal">
        ...
        <div class="mapflex1">
                  <div class="ConfirmedCaseContainer">
                      ...
                      <div class="number" style="font-size:42px; font-weight: bold">
                        {{WorldTotal.total_cases}}
                      </div>
                  </div>
                  <div class="ConfirmedCaseContainer">
                      <div class="caseheading">
                      ...
                      <div class="number" style="font-size:42px;  ">
                          {{WorldTotal.new_cases}}
                      </div>
                  </div>
        </div>
        <div class="mapflex2">
